...
from exchange_statements import huobipro_file_manager

if __name__ == '__main__':
	bfm = huobipro_file_manager()
	saved_path = bfm.update()
	if saved_path:
		print('saved huobipro exchange statement to {}'.format(saved_path))
	else:
		print('failed to save huobipro exchange statement')